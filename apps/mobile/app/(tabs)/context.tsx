...
export default function ContextScreen() {
  ...
  const showPlannedFeature = (feature: string) => {
    Alert.alert('In progress', `${feature} is planned but not connected yet.`)
  }
    ...
    <SafeAreaView className={`flex-1 ${bg}`} edges={['top']}>
      ...
      >
        ...
        <View className="flex-row items-start justify-between mt-4 mb-5">
          ...
          <Pressable onPress={() => showPlannedFeature('Settings')}><Text style={{ fontSize: 20 }}>⚙️</Text></Pressable>
        </View>
          ...
          <>
              ...
              {[
                ...
                >
                  ...
                  {cal.connected ? (
                    ...
                    <Pressable
                      onPress={() => showPlannedFeature(`${cal.name} sync`)}
            ...
            <View className="mb-4">
              ...
              {[
                ...
                <Pressable
                  key={param.title}
                  onPress={() => showPlannedFeature(param.title)}
